...
The library includes multiple built-in cache backend implementations beyond the defaults!
...
### 7. Custom Cache Backends

You can replace the default Moka (L1) and Redis (L2) backends with your own custom implementations!
...
- GitHub Issues: [Report bugs or request features](https://github.com/liveonassist/multi-level-cache/issues)
